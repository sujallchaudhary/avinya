      ...
      <div className="container flex h-14 items-center">
        <div className="mr-4 flex">
          <Link href="/" className="mr-6 flex items-center space-x-2">
            <Image alt="logo" src="https://sdrive.blr1.cdn.digitaloceanspaces.com/files/147f5a9b9f68d2f31a43080ba18d61c0.png" height={400} width={400} className="h-6 w-6 hidden sm:flex" />
